...
set "out_directory=C:\Users\hooll\Dropbox\19 PostGrad\Genomic Medicine\Research Module\Data\annotations\all annotations\corrected"
...
for %%t in (%list%) do (
    ...
    for /F "tokens=1,2 delims=:" %%a in ("%%t") do (
		...
		echo copying "%merge_directory%\%%a\data.qpdata" to "%out_directory%\%%b.qpdata"
		copy "%merge_directory%\%%a\data.qpdata" "%out_directory%\%%b.qpdata"

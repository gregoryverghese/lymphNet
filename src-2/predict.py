...
if __name__=='__main__':
    ...
    ap.add_argument('-ip','--test_path',required=True,help='path to test images and masks')
    ap.add_argument('-ip','--save_path',required=True,help='experiment folder for saving results')

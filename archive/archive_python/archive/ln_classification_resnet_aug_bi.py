...
def getClassification():
    ...
    resultsDict = {'RESNET': classPredictions[0], 'TRUE': testGenerator.classes}
    results = pd.DataFrame(resultsDict)
    results.to_csv('/home/verghese/results_RESNET_aug_bi_2.csv')
    results.to_csv('/home/verghese/output/results_RESNET_aug_bi_2.csv')

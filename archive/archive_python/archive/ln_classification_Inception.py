...
def getClassification():
    ...
    resultsDict = {'Results': classes[0], 'TRUE': labels}
    results = pd.DataFrame(resultsDict)
    results.to_csv('/home/verghese/output/results_Inception.csv')
    results.to_csv('/home/verghese/output/ln_classification_bin_Inception.csv')

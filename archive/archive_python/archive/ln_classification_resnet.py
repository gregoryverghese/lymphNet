...
def getClassification():
    ...
    resultsDict = {'RESNET': classes[0], 'TRUE': labels}
    results = pd.DataFrame(resultsDict)
    results.to_csv('/home/verghese/results_resnet.csv')
    results.to_csv('/home/verghese/output/ln_classification_bin_1_resnet.csv')

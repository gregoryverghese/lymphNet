...
MODELNAMES = ['VGG16']
BASEDIR = '/SAN/colcc/WSI_LymphNodes_BreastCancer/Greg/data/patches/classification/mock'
#BASEDIR = 'test3'
RATIO = 0.8
WEIGHTS = 'imagenet'
...
def getClassification():
    ...
    trainGenerator, validGenerator, testGenerator = getGenerators(trainDir, validationDir, AUGMENT, (IMGSIZE, IMGSIZE), BATCH, 'binary')
    ...
    classPredictions = np.argmax(predictions[0], axis=-1)

    resultsDict = {'VGG16': classPredictions[0], 'TRUE': labels}
    results = pd.DataFrame(resultsDict)
    results.to_csv('/home/verghese/results_VGG16.csv')
    results.to_csv('/home/verghese/output/ln_classification_bin_1_VGG16.csv')

...
import unet_mini
import atten_unet
import distributed_train3 as train
...
#        print('trainable variables', str(model.trainable_variables))
        ...
        trainer = train.Train(model, loss, optimizer, strategy, epoch, batchSize, trainSteps, validSteps)
        ...
        model, history = trainer.forward(trainDistDataset, validDistDataset)
        '''

    train.distributeTrain(epoch, batchSize, imgDims, filters, trainDataset, validDataset, trainSteps, validSteps, 2)

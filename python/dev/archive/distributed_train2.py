...
class Train(object):
    ...
    def __init__(self, epochs, model, optimizer, lossObject, batchSize, strategy, trainSteps, testSteps, imgDims):
        self.epochs = epochs
    ...
    def forward(self, trainDistDataset, testDistDataset, strategy):
        ...
        trainLogDir = os.path.join('tensorboard_logs', currentTime, 'train')
        testLogDir = os.path.join('tensorboard_logs', currentTime, 'test')

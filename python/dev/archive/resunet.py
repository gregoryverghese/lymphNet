...
class Unet():
    def __init__(self, imgSize, activation='relu', finalActivation='sigmoid', padding='same'):
    ...
    def ResUnet(self, filters = [8, 16, 32, 64, 128]):
        ...
        x = keras.layers.Conv2D(1, (1, 1), padding='same', activation=self.finalActivation)(d4)

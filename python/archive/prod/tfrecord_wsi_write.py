...
outPath = '/SAN/colcc/WSI_LymphNodes_BreastCancer/Greg/data/patches/segmentation/10x/one/tfrecords/tfrecords_wsi/sinus'
images = glob.glob('output/patches/2/*')
maskPath = 'output/masks/2/sinus'

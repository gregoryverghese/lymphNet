...
def forward(model, optimizer, epochs, trainDataset, validDataset, trainSteps):
    ...
    for e in range(epochs):
        ...
        tf.print('Epoch: {}/{}...'.format(e+1, epochs))
        ...
        for i, data in enumerate(trainDataset):
            ...
            if i==trainSteps:
                print(i)
                tf.print('  epoch {}: loss - {:.2f}, dice - {:.2f}'.format(e, loss, dice), end="")
            else:
                tf.print('  epoch {}: loss - {:.2f}, dice - {:.2f}'.format(e, loss, dice), end="\r")
        ...
        tf.print('epoch {}: avg loss - {:.2f}, avg dice - {:.2f}'.format(e, avgLoss, avgDice))
        ...
        tf.print('epoch {}: val_dice - {:.2f}'.format(e, avgDice))

...
class ResUnet():
    def __init__(self, imgDims, nOutput=1, finalActivation='sigmoid', activation='relu', padding='same', dropout=0):
    ...
    def encoder(self, x, filters, kernelSize=(3,3), padding='same', strides=1, dropout=0):
    ...
    def ResUnet(self, filters = [4, 8, 16, 32, 64]):
